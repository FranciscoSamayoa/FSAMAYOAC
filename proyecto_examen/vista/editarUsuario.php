                            ...
                            <?php foreach ($datos as $array) : ?>
                                <?php foreach ($array as $usuario) : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $usuario['user']?>" class="form-control" id="user" name="user" placeholder="Escribe un usuario">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Contraseña</label>
                                        <input type="text" value="<?php echo $usuario['password']?>" class="form-control" id="password" name="password" placeholder="Escribe una contraseña">
                                    </div>
                                    <div class="form-group">
                                        <br>
